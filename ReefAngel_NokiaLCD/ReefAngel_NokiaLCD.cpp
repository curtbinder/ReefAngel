...
void ReefAngel_NokiaLCD::DrawLargeTextLine(byte fcolor, byte bcolor, byte x, byte y, uint16_t c, byte height)
{
	int i;
	byte inc;
	byte xoffset;
...
void ReefAngel_NokiaLCD::DrawLargeText(byte fcolor, byte bcolor, byte x, byte y, char* text, byte height /*= Font8x8*/)
{
	uint16_t c;
	int t;
...
void ReefAngel_NokiaLCD::DrawHugeText(byte fcolor, byte bcolor, byte x, byte y, char* text, byte height /*= Font12x16*/)
{
	uint16_t c;
	int t;
	byte w = 16;
